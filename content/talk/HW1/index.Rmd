...
3.  We showed that $P_X = X(X^TX)^{-1}X^T$ was an orthogonal
 ...
 obtained be back-solving thus avoiding the matrix inverse of $X^TX$.
  ...
  $L^T \beta = w$ avoiding any matrix inversion.  Write this out in psuedo-code.
     ...
     (Try using Rmarkdown for writing up the solution!)
...
For the parts that involve `R` write up using knitr in Rstudio to generate a PDF.  Upload your R code and pdf to Sakai. The other parts may be written using knitr or by hand and scanned in. 
